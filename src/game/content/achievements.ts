...
export const ACHIEVEMENTS: AchievementDefinition[] = [
  {
    id: 'bride-stage-1',
    name: '감동의 재회',
    description: '용사로 1스테이지를 easy 이상의 난이도로 클리어한다.',
    iconKey: 'reunion',
  },
  {
    id: 'bride-stage-2',
    name: 'Defense!',
    description: '용사로 2스테이지를 easy 이상의 난이도로 클리어한다.',
    iconKey: 'cap',
  },
  {
    id: 'bride-stage-3',
    name: '새로운 시작',
    description: '용사로 3스테이지를 easy 이상의 난이도로 클리어한다.',
    iconKey: 'bouquet',
  },
  {
  ...
  },
  {
    id: 'dragon-stage-1',
    name: '프로포즈',
    description: '용으로 1스테이지를 easy 이상의 난이도로 클리어한다.',
    iconKey: 'ring',
  ...
  },
  {
    id: 'dragon-stage-2',
    name: '또 한명의 박사',
    description: '용으로 2스테이지를 easy 이상의 난이도로 클리어한다.',
    iconKey: 'double-cap',
    hiddenUntilDragonUnlocked: true,
  },
  {
    id: 'dragon-stage-3',
    name: '행복한 사랑',
    description: '용으로 3스테이지를 easy 이상의 난이도로 클리어한다.',
    iconKey: 'heart',
    hiddenUntilDragonUnlocked: true,
  },
  {
  ...
  },
  {
    ...
    name: '사진 공포증',
    description: '3스테이지에서 카메라 광선을 한 대도 맞지 않고 클리어한다.',
    iconKey: 'camera',
  },
  {
    id: 'stage-2-defense-no-hit',
    name: '완벽한 논문',
    description: '2스테이지 보스전에서 디펜스를 맞지 않고 클리어한다.',
    iconKey: 'thesis',
  },
  {
    id: 'stage-1-train-no-hit',
    name: '예매마스터',
    description: '1스테이지 기차 보스전에서 한 대도 맞지 않고 클리어한다.',
    iconKey: 'ticket',
  },
]
